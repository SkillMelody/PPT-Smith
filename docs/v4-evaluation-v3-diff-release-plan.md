...
> **历史评估，已被取代。** 本文基于“V4 单路径、模型只写内容、规则引擎拥有全部视觉决策”的旧假设。该假设现在仅适用于 Standard；当前三路线边界以 [v4-three-route-architecture.md](v4-three-route-architecture.md) 为准。本文中的“核心价值已达成、值得发布”不再代表当前发布结论。
